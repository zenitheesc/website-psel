        ...
        <div>
          <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", textAlign: "center" }}>
            ...
            <TextInfo counter={counter} target={1} addCounter={addCounter}>
              ...
              1-<span style={{ color: "blue" }}>▒▒▒</span> &nbsp; 2-<span style={{ color: "red" }}>▒▒▒</span> &nbsp; 3-
              <span style={{ color: "yellow" }}>▒▒▒</span> &nbsp; 4-<span style={{ color: "green" }}>▒▒▒</span>
            </TextInfo>
          ...
          <TextInput counter={counter} target={4} addCounter={addBothCounter} pass={passwords.fiosColoridos.modulo_um}>
          ...
          <TextInput counter={counter} target={8} addCounter={addBothCounter} pass={passwords.fiosColoridos.modulo_dois}>
          ...
          <TextInput counter={counter} target={12} addCounter={addBothCounter} pass={passwords.fiosColoridos.modulo_tres}>
